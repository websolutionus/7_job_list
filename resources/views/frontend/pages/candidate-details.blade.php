    ...
    <div class="container">
      ...
      <div class="box-nav-tabs mt-40 mb-5">
        <ul class="nav" role="tablist">
          <li><a class="btn btn-border recruitment-icon mr-15 mb-5 active" href="#tab-short-bio" data-bs-toggle="tab"
              role="tab" aria-controls="tab-short-bio" aria-selected="true">Short Bio</a></li>
          <li><a class="btn btn-border recruitment-icon mr-15 mb-5" href="#tab-skills" data-bs-toggle="tab" role="tab"
              aria-controls="tab-skills" aria-selected="false">Skills</a></li>
          <li><a class="btn btn-border recruitment-icon mb-5" href="#tab-work-experience" data-bs-toggle="tab"
              role="tab" aria-controls="tab-work-experience" aria-selected="false">Working Experience</a></li>
        </ul>
      </div>
          ...
          <div class="content-single">
            <div class="tab-content">
              <div class="tab-pane fade show active" id="tab-short-bio" role="tabpanel"
                ...
                <h4>About Me</h4>
                <p>Hello there! My name is Alan Walker. I am a graphic designer, and I&rsquo;m very passionate and
                  dedicated to my work. With 20 years experience as a professional a graphic designer, I have acquired
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis illum fuga eveniet. Deleniti
                  asperiores, commodi quae ipsum quas est itaque, ipsa, dolore beatae voluptates nemo blanditiis iste
                ...
                <div class="row mb-40">
                  <div class="col-lg-6 col-md-6 col-sm-12 mb-30">
                    ...
                    <div class="box-progress-bar mt-20">
                      ...
                      <div class="progress">
                        <div class="progress-bar bg-paragraph-2" role="progressbar" style="width: 78%"
                          aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><span>78%</span></div>
                      </div>
                      <p class="font-xs color-text-paragraph-2 mb-10 mt-30">Javascript</p>
                      <div class="progress">
                        <div class="progress-bar bg-brand-2" role="progressbar" style="width: 88%" aria-valuenow="50"
                          aria-valuemin="0" aria-valuemax="100"><span>88%</span></div>
                      </div>
                      <p class="font-xs color-text-paragraph-2 mb-10 mt-30">Database</p>
                      <div class="progress">
                        <div class="progress-bar bg-paragraph-2" role="progressbar" style="width: 62%"
                          aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><span>62%</span></div>
                      </div>
                      <p class="font-xs color-text-paragraph-2 mb-10 mt-30">React JS</p>
                      <div class="progress">
                        <div class="progress-bar bg-paragraph-2" role="progressbar" style="width: 92%"
                          aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"><span>92%</span></div>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-12 mb-30">
                    ...
                    <div class="box-progress-bar mt-20">
                      ...
                      <div class="progress">
                        <div class="progress-bar bg-paragraph-2" role="progressbar" style="width: 29%"
                          aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><span>29%</span></div>
                      </div>
                      <p class="font-xs color-text-paragraph-2 mb-10 mt-30">Figma</p>
                      <div class="progress">
                        <div class="progress-bar bg-paragraph-2" role="progressbar" style="width: 20%"
                          aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"><span>20%</span></div>
                      </div>
                      <p class="font-xs color-text-paragraph-2 mb-10 mt-30">Illustrator</p>
                      <div class="progress">
                        <div class="progress-bar bg-paragraph-2" role="progressbar" style="width: 65%"
                          aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><span>65%</span></div>
                      </div>
                      <p class="font-xs color-text-paragraph-2 mb-10 mt-30">Sketch</p>
                      <div class="progress">
                        <div class="progress-bar bg-paragraph-2" role="progressbar" style="width: 82%"
                          aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"><span>82%</span></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <ul>
                  ...
                  <li>A Bachelor&rsquo;s Degree in Design (or related field) or equivalent professional experience
                  </li>
              ...
              <div class="tab-pane fade" id="tab-skills" role="tabpanel" aria-labelledby="tab-skills">
                <h4>Skills</h4>
                <p></p>Hello there! My name is Alan Walker. I am a graphic designer, and I&rsquo;m very passionate and
                dedicated to my work. With 20 years experience as a professional a graphic designer, I have acquired
                the skills and knowledge necessary to make your project a success.
                <p></p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis illum fuga eveniet. Deleniti
                asperiores, commodi quae ipsum quas est itaque, ipsa, dolore beatae voluptates nemo blanditiis iste
                  ...
                  <div class="card-block-info">
                    ...
                    <div class="card-2-bottom mt-20">
                      <div class="row">
                        ...
                        <div class="col-lg-5 col-5 text-end"><a class="btn btn-apply-now" href="job-details.html">View
                            Details</a></div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="sidebar-list-job">
              <ul>
                ...
                <li>
                  ...
                  <div class="sidebar-text-info"><span class="text-description">Expected Salary</span><strong
                      class="small-heading">$26k - $30k</strong></div>
                </li>
                <li>
