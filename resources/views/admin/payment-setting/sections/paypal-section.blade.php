            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="paypal_country_name" class="form-control {{ hasError($errors, 'paypal_country_name') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="paypal_currency_name" class="form-control {{ hasError($errors, 'paypal_currency_name') }}">
                            <option value="sandbox"></option>
                        </select>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ hasError($errors, 'paypal_client_id') }}" name="paypal_client_id" >
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ hasError($errors, 'paypal_client_secret') }}" name="paypal_client_secret" >
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ hasError($errors, 'paypal_app_id') }}" name="paypal_app_id" >
